...
const multerFilter = (req, file, cb) => {
    if (file.mimetype.startsWith('image')) {
        ...
        cb(
            new AppError('Not and image! Please upload only images.', 400),
            false,
        );
    }
};
...
//* '/tours_within/:distance/center/:latlng/unit/:unit'
//* /tours-within/233/center/30.804704,31.332037/unit/mi
...
exports.getDistances = catchAsyncError(async (req, res, next) => {
    ...
    const multiplier = unit === 'mi' ? 0.000621371 : 0.001; //* meter → mile
