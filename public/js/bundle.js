    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error resetting password! Try again.');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          res = _context5.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Password resetting successfully');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log('Ok');
          stripe = Stripe('pk_test_51OYNMvHDcMNy1ETb38UJvVZ0E2BDIXfv6cF8YCLksfmQGCtJyMupzC3eDKsWTrztYGHsJ1FlJXv4qT95uTsTYRRn003sLegyU9');
          _context.prev = 2;
          _context.next = 5;
...
if (forgotPasswordForm) addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  (0, _login.forgotPassword)(email);
});
if (resetPasswordForm) addEventListener('submit', function (e) {
  e.preventDefault();
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('passwordConfirm').value;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38882" + '/');
